...
- 变更类型: `new`
- 用户确认摘要: `2026-04-29` 用户确认 subagent baseline 应以本地 orchestration extension 暴露 repository-owned `dispatch` tool，并以 `pi-subagents` 作为初始执行底座，同时为未来扩展到更完整 orchestration 层保留稳定接口
