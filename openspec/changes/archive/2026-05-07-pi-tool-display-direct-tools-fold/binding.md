...
- `spec_standard_ref`: 本 change 为 fork 内缺陷修复，不涉及新 capability spec
- `project_page_ref`: `repo://pi-config`
- `additional_context_refs`: `docs/plans/pi-tool-display-mcp-direct-tools-bug-analysis.md`, `forks/manifest.yaml`
...
- `writeback_targets`: `forks/manifest.yaml`, `openspec/pkg-backlog.md`
