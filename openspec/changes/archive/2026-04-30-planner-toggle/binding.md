...
- `project_page_ref`: `openspec/pkg-backlog.md` (pi-config 项目 backlog 页面)
- `additional_context_refs`:
  - `AGENTS.md` (项目行为规范与工作流约束)
  - `docs/plans/pi-customization-reference.md` (Pi 定制化参考，Section 3 扩展系统)
  - `.pi/skills/pi-extension-dev/SKILL.md` (扩展开发流程技能)

## Source of Truth

- 行为规范真源：`specs/planner-toggle/spec.md`
