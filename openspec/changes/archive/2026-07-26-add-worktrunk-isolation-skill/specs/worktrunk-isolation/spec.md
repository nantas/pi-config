...
- Capability: `worktrunk-isolation`
- 来源: `proposal.md` / 已确认 capabilities
- 变更类型: `new`
- 用户确认摘要: 单一 New Capability `worktrunk-isolation`，model-invoked，同步至 `global.skills`；命名 `worktrunk-isolation`；preflight 即 doctor（不写脚本）。
