...
- `additional_context_refs`: `docs/plans/worktrunk-isolation-skill-handoff.md`
...
- handoff 文档 `docs/plans/worktrunk-isolation-skill-handoff.md` 作为需求基线参考输入，不替代 change artifacts 的约束效力
