# pkg-decision-backlog

## Purpose

Provide a three-option decision framework after package research (global config / backlog / discard), manage `.pi/settings.json` rollback for non-global decisions, and persist decisions in a structured `openspec/pkg-backlog.md`.
